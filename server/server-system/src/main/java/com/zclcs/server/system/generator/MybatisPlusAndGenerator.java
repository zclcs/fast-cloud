package com.zclcs.server.system.generator;
...
public class MybatisPlusAndGenerator {
    public static void main(String[] args) {
        ...
        pc.setParent("com.zclcs.server.system");
        pc.setEntity("entity");
        pc.setMapper("mapper");
        pc.setXml("mapper");
        ...
        //生成指定表
        strategyConfig.setInclude("system_data_permission_test", "system_dept", "system_export",
                "system_log", "system_login_log", "system_menu",
                "system_role", "system_role_menu", "system_trade_log",
                "system_user", "system_user_data_permission", "system_user_role");
        // 模糊查询表
