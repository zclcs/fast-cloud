...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '代码生成配置表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of generator_config
-- ----------------------------
INSERT INTO `generator_config` VALUES (1, 'zclcs', 'com.zclcs', 'common.core.entity.dict', 'common.core.entity.dict.ao', 'common.core.entity.dict.vo', 'server.dict.mapper', 'server.dict.mapper', 'server.dict.service', 'server.dict.service.impl', 'server.dict.controller', '0', NULL);
